...
public class Inventory implements Serializable {
    ...
    @Column(name = "cash_desk_applicationid")
    private Long cashDeskApplicationid;
    ...
    public Inventory storeid(Long storeid) {
    ...
    public Long getCashDeskApplicationid() {
        return cashDeskApplicationid;
    }

    public Inventory cashDeskApplicationid(Long cashDeskApplicationid) {
        this.cashDeskApplicationid = cashDeskApplicationid;
        return this;
    }

    public void setCashDeskApplicationid(Long cashDeskApplicationid) {
        this.cashDeskApplicationid = cashDeskApplicationid;
    }
    ...
    public String toString() {
        return "Inventory{" +
            "id=" + getId() +
            ", storeid=" + getStoreid() +
            ", cashDeskApplicationid=" + getCashDeskApplicationid() +
            "}";
    }
}
