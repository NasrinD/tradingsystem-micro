...
import org.jhipster.inventoryservice.repository.InventoryRepository;
...
public class InventoryResourceIntTest {
    ...
    private static final Long DEFAULT_STOREID = 1L;
    private static final Long UPDATED_STOREID = 2L;

    private static final Long DEFAULT_CASH_DESK_APPLICATIONID = 1L;
    private static final Long UPDATED_CASH_DESK_APPLICATIONID = 2L;
    ...
    public static Inventory createEntity(EntityManager em) {
        Inventory inventory = new Inventory()
            ...
            .cashDeskApplicationid(DEFAULT_CASH_DESK_APPLICATIONID);
        return inventory;
    }
    ...
    public void createInventory() throws Exception {
        ...
        assertThat(testInventory.getStoreid()).isEqualTo(DEFAULT_STOREID);
        assertThat(testInventory.getCashDeskApplicationid()).isEqualTo(DEFAULT_CASH_DESK_APPLICATIONID);
    }
    ...
    public void getAllInventories() throws Exception {
        ...
        restInventoryMockMvc.perform(get("/api/inventories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].storeid").value(hasItem(DEFAULT_STOREID.intValue())))
            .andExpect(jsonPath("$.[*].cashDeskApplicationid").value(hasItem(DEFAULT_CASH_DESK_APPLICATIONID.intValue())));
    }
    ...
    public void getInventory() throws Exception {
        ...
        restInventoryMockMvc.perform(get("/api/inventories/{id}", inventory.getId()))
            ...
            .andExpect(jsonPath("$.storeid").value(DEFAULT_STOREID.intValue()))
            .andExpect(jsonPath("$.cashDeskApplicationid").value(DEFAULT_CASH_DESK_APPLICATIONID.intValue()));
    }
    ...
    public void updateInventory() throws Exception {
        ...
        updatedInventory
            ...
            .cashDeskApplicationid(UPDATED_CASH_DESK_APPLICATIONID);
        ...
        Inventory testInventory = inventoryList.get(inventoryList.size() - 1);
        assertThat(testInventory.getStoreid()).isEqualTo(UPDATED_STOREID);
        assertThat(testInventory.getCashDeskApplicationid()).isEqualTo(UPDATED_CASH_DESK_APPLICATIONID);
    }
