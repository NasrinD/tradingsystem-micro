...
public class ReceiptItemResourceIntTest {
    ...
    private static final BigDecimal DEFAULT_PRODUCT_SALES_PRICE = new BigDecimal(1);
    private static final BigDecimal UPDATED_PRODUCT_SALES_PRICE = new BigDecimal(2);
    ...
    public static ReceiptItem createEntity(EntityManager em) {
        ReceiptItem receiptItem = new ReceiptItem()
            ...
            .productSalesPrice(DEFAULT_PRODUCT_SALES_PRICE)
    ...
    public void createReceiptItem() throws Exception {
        ...
        assertThat(testReceiptItem.getProductSalesPrice()).isEqualTo(DEFAULT_PRODUCT_SALES_PRICE);
    ...
    @Test
    @Transactional
    public void checkProductSalesPriceIsRequired() throws Exception {
        int databaseSizeBeforeTest = receiptItemRepository.findAll().size();
        // set the field null
        receiptItem.setProductSalesPrice(null);
    ...
    public void getAllReceiptItems() throws Exception {
        ...
        restReceiptItemMockMvc.perform(get("/api/receipt-items?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].productSalesPrice").value(hasItem(DEFAULT_PRODUCT_SALES_PRICE.intValue())))
    ...
    public void getReceiptItem() throws Exception {
        ...
        restReceiptItemMockMvc.perform(get("/api/receipt-items/{id}", receiptItem.getId()))
            ...
            .andExpect(jsonPath("$.productSalesPrice").value(DEFAULT_PRODUCT_SALES_PRICE.intValue()))
    ...
    public void updateReceiptItem() throws Exception {
        ...
        updatedReceiptItem
            ...
            .productSalesPrice(UPDATED_PRODUCT_SALES_PRICE)
        ...
        assertThat(testReceiptItem.getProductSalesPrice()).isEqualTo(UPDATED_PRODUCT_SALES_PRICE);
