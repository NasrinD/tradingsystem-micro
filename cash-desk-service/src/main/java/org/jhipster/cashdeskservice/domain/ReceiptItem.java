...
public class ReceiptItem implements Serializable {
    ...
    @NotNull
    @Column(name = "product_sales_price", precision=10, scale=2, nullable = false)
    ...
    public ReceiptItem productSalesPrice(BigDecimal productSalesPrice) {
    ...
    public String toString() {
        return "ReceiptItem{" +
            ...
            ", productSalesPrice=" + getProductSalesPrice() +
