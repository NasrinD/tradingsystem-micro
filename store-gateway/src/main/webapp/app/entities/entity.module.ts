...
import { StoreIssuingBankModule } from './issuing-bank/issuing-bank.module';
import { StoreDebitModule } from './debit/debit.module';
import { StoreAcquiringBankModule } from './acquiring-bank/acquiring-bank.module';
...
@NgModule({
    imports: [
        ...
        StoreIssuingBankModule,
        StoreDebitModule,
        StoreAcquiringBankModule,
        StoreNetworkModule,
