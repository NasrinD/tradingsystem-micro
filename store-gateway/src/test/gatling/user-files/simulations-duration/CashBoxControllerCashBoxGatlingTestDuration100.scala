 ...
 */
class CashBoxControllerGatlingTestDuration100 extends Simulation {
    ...
    val scn = scenario("Test the CashBoxController entity").during(2 minutes) {
        ...
        .repeat(2) {
            ...
            .check(status.is(201))
            .check(headerRegex("Location", "(.*)").saveAs("new_cashBox_url"))).exitHereIfFailed
            .pause(10)
            .repeat(5) {
